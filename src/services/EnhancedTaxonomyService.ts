...
export interface EnhancedVendorData {
  ...
  operating_system_support: string[];
  virtualization_support: string[];
  container_support: string[];
  kubernetes_support: boolean;
  docker_support: boolean;
  microservices_architecture: boolean;
  api_first_design: boolean;
  headless_architecture: boolean;
  modular_components: boolean;
  plugin_architecture: boolean;
  extension_points: string[];
  customization_options: string[];
  white_labeling: boolean;
  oem_partnerships: boolean;
  reseller_programs: boolean;
  distributor_network: string[];
  global_presence: string[];
  local_support_offices: string[];
  language_support: string[];
  localization_features: string[];
  currency_support: string[];
  tax_calculation: boolean;
  invoicing_features: string[];
  procurement_integration: string[];
  contract_management: boolean;
  license_management: boolean;
  asset_management: boolean;
  inventory_tracking: boolean;
  warranty_management: boolean;
  maintenance_scheduling: boolean;
  update_management: boolean;
  patch_management: boolean;
  security_updates: string;
  feature_updates: string;
  major_version_releases: string;
  backwards_compatibility: string;
  migration_tools: string[];
  upgrade_assistance: boolean;
  data_migration_support: boolean;
  configuration_migration: boolean;
  policy_migration: boolean;
  user_migration: boolean;
  device_migration: boolean;
  rollback_capabilities: boolean;
  testing_environments: boolean;
  ...
  planned_outages: string;
  unplanned_outage_history: string;
  ...
  configuration_as_code: boolean;
  policy_as_code: boolean;
  security_as_code: boolean;
  compliance_as_code: boolean;
    ...
    return [
      {
        ...
        // continuous_monitoring removed to avoid duplicate - defined later
