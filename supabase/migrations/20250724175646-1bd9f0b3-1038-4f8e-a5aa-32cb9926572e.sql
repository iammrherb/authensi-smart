-- Pre-populate vendor library with comprehensive vendor data
...
-- NAC Vendors
(gen_random_uuid(), 'Portnox', 'NAC Solutions', 'primary', 'active', 'premium',
...
(gen_random_uuid(), 'Cisco Catalyst', 'Network Switches', 'infrastructure', 'active', 'premium',
...
(gen_random_uuid(), 'Aruba CX', 'Network Switches', 'infrastructure', 'active', 'premium',
...
(gen_random_uuid(), 'Cisco Wireless', 'Wireless Controllers', 'infrastructure', 'active', 'premium',
 '["WLC 9800", "AireOS WLC", "Catalyst 9800"]'::jsonb,
 '["IEEE 802.1X", "WPA3", "RADIUS", "CAPWAP"]'::jsonb,
 '["REST API", "SNMP", "SSH"]'::jsonb,
 '{"compatibility_score": 95, "native_integration": true}'::jsonb,
 '{"basic": "WPA2-Enterprise", "advanced": "WPA3 Enterprise"}'::jsonb,
 '{"minimum_version": "17.6", "recommended_version": "17.9"}'::jsonb,
 '[]'::jsonb,
 '[{"title": "Wireless Configuration", "url": "#", "type": "setup"}]'::jsonb),

(gen_random_uuid(), 'Aruba Wireless', 'Wireless Controllers', 'infrastructure', 'active', 'premium',
 '["MM 8.10", "MM 8.11", "InstantOS"]'::jsonb,
 '["IEEE 802.1X", "WPA3", "RADIUS", "CAPWAP"]'::jsonb,
 '["REST API", "CLI", "SNMP"]'::jsonb,
 '{"compatibility_score": 92, "native_integration": true}'::jsonb,
 '{"basic": "WPA2-Enterprise", "advanced": "WPA3 Enterprise"}'::jsonb,
 '{"minimum_version": "8.10", "recommended_version": "8.11"}'::jsonb,
 '[]'::jsonb,
 '[{"title": "ArubaOS Configuration", "url": "#", "type": "setup"}]'::jsonb),
...
(gen_random_uuid(), 'Palo Alto Networks', 'Firewalls', 'security', 'active', 'standard',
 '["PA-220", "PA-850", "PA-3220", "PA-5220"]'::jsonb,
 '["RADIUS", "TACACS+", "SAML", "REST API"]'::jsonb,
 '["XML API", "CLI", "SNMP"]'::jsonb,
 '{"compatibility_score": 80, "native_integration": false, "api_integration": true}'::jsonb,
 '{"basic": "User-ID integration", "advanced": "HIP compliance"}'::jsonb,
 '{"minimum_version": "10.1", "recommended_version": "11.0"}'::jsonb,
 '["Complex User-ID setup", "Requires GlobalProtect for full features"]'::jsonb,
 '[{"title": "PAN-OS Integration", "url": "#", "type": "setup"}]'::jsonb),

-- Identity Providers
(gen_random_uuid(), 'Microsoft Active Directory', 'Identity Providers', 'identity', 'active', 'premium',
...
(gen_random_uuid(), 'Okta', 'Identity Providers', 'identity', 'active', 'standard',
 '["Universal Directory", "Workforce Identity", "Customer Identity"]'::jsonb,
 '["SAML", "OIDC", "SCIM", "RADIUS"]'::jsonb,
 '["REST API", "SCIM", "Webhooks"]'::jsonb,
 '{"compatibility_score": 90, "native_integration": false, "api_integration": true}'::jsonb,
 '{"basic": "SAML SSO", "advanced": "Adaptive MFA"}'::jsonb,
 '{"minimum_version": "N/A", "recommended_version": "Latest"}'::jsonb,
 '["RADIUS proxy required for network access"]'::jsonb,
 '[{"title": "Okta SAML Setup", "url": "#", "type": "setup"}]'::jsonb),

-- MDM Solutions
(gen_random_uuid(), 'Microsoft Intune', 'MDM Solutions', 'endpoint', 'active', 'premium',
...
(gen_random_uuid(), 'VMware Workspace ONE', 'MDM Solutions', 'endpoint', 'active', 'standard',
 '["UEM", "Access", "Intelligence"]'::jsonb,
 '["SCEP", "REST API", "SAML"]'::jsonb,
 '["REST API", "CLI", "PowerShell"]'::jsonb,
 '{"compatibility_score": 85, "native_integration": false, "api_integration": true}'::jsonb,
 '{"basic": "Device enrollment", "advanced": "Risk analytics"}'::jsonb,
 '{"minimum_version": "21.08", "recommended_version": "22.09"}'::jsonb,
 '["Complex API setup", "Requires Hub Services"]'::jsonb,
 '[{"title": "Workspace ONE Guide", "url": "#", "type": "setup"}]'::jsonb)
