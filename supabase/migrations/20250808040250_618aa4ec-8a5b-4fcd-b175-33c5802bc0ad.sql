-- Robust insert using ON CONFLICT DO NOTHING against unique_vendor_name
...
ON CONFLICT ON CONSTRAINT unique_vendor_name DO NOTHING;
...
-- Seed representative models with firmware for new vendors (skip if vendor missing)
