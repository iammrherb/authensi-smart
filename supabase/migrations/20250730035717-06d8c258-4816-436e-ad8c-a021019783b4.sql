...
SELECT 'Dell Technologies', 'Enterprise', 'Infrastructure', 'tier1', 'Enterprise networking solutions including switches, routers, and wireless systems', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM vendor_library WHERE vendor_name = 'Dell Technologies');

INSERT INTO vendor_library (vendor_name, category, vendor_type, support_level, description, created_at, updated_at) 
SELECT 'Huawei', 'Enterprise', 'Infrastructure', 'tier1', 'Global provider of ICT infrastructure and smart devices', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM vendor_library WHERE vendor_name = 'Huawei');

INSERT INTO vendor_library (vendor_name, category, vendor_type, support_level, description, created_at, updated_at) 
SELECT 'Alcatel-Lucent Enterprise', 'Enterprise', 'Infrastructure', 'tier1', 'Enterprise networking and communications solutions', NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM vendor_library WHERE vendor_name = 'Alcatel-Lucent Enterprise');

INSERT INTO vendor_library (vendor_name, category, vendor_type, support_level, description, created_at, updated_at) 
SELECT 'Ubiquiti', 'Enterprise', 'Infrastructure', 'tier2', 'Enterprise WiFi and networking equipment with centralized management', NOW(), NOW()
