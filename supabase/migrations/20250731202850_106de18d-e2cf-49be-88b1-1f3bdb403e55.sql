-- Fix create_user_safely function to work with current auth setup
...
BEGIN
  ...
  -- Generate a random user ID for the invitation
  ...
  v_result := jsonb_build_object(
    'success', true,
    'user_id', v_user_id,
    'message', 'User created successfully. They need to sign up to activate their account.'
  );
