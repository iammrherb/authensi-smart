-- Fix vendor data insertion and RLS policies

-- Add unique constraint to vendor_library if it doesn't exist
ALTER TABLE vendor_library ADD CONSTRAINT unique_vendor_name UNIQUE (vendor_name);

-- Insert comprehensive vendor data without ON CONFLICT for now
