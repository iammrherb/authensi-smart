...
-- Add project and site associations to use_cases
ALTER TABLE use_cases ADD COLUMN IF NOT EXISTS associated_projects jsonb DEFAULT '[]'::jsonb;
ALTER TABLE use_cases ADD COLUMN IF NOT EXISTS associated_sites jsonb DEFAULT '[]'::jsonb;
ALTER TABLE use_cases ADD COLUMN IF NOT EXISTS tags jsonb DEFAULT '[]'::jsonb;
ALTER TABLE use_cases ADD COLUMN IF NOT EXISTS custom_categories jsonb DEFAULT '[]'::jsonb;
...
CREATE TRIGGER update_resource_tags_updated_at BEFORE UPDATE ON resource_tags
