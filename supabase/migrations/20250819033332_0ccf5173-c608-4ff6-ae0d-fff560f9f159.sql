-- =============================================================================
-- POPULATE DEFAULT DATA FOR AI INTEGRATION AND WORKFLOWS
-- =============================================================================
...
-- =============================================================================
-- ENHANCED VENDOR DATA WITH COMPREHENSIVE API INTEGRATIONS
-- =============================================================================

-- Update existing vendors with API integration capabilities
UPDATE vendors SET 
  metadata = COALESCE(metadata, '{}'::jsonb) || '{
    ...
    "portnox_integration": {
      ...
      "auth_methods": ["radius", "802.1x", "web_auth"],
      "policy_enforcement": true
    }
  }'::jsonb
WHERE name IN ('Cisco', 'Aruba', 'Fortinet', 'Palo Alto Networks', 'Check Point', 'Juniper', 'Extreme Networks', 'Ruckus');
