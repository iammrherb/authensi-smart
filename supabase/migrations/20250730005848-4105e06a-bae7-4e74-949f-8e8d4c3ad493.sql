...
UPDATE public.vendor_library SET 
  ...
  portnox_documentation = '{"guides": ["cisco-catalyst-guide.pdf"], "best_practices": ["cisco-802.1x-bp.pdf"], "integration_notes": "Full support for all Catalyst series"}'::jsonb
...
SELECT 'Aruba', 'network', 'switch', 'HPE Aruba networking switches with advanced security features', 'https://arubanetworks.com', 'certified', '{"guides": ["aruba-cx-guide.pdf"], "best_practices": ["aruba-clearpass-integration.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Aruba');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'Fortinet', 'security', 'firewall', 'Enterprise security and networking solutions', 'https://fortinet.com', 'supported', '{"guides": ["fortigate-802.1x.pdf"], "integration_notes": "FortiGate firewall integration"}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Fortinet');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'Juniper', 'network', 'switch', 'High-performance networking solutions', 'https://juniper.net', 'supported', '{"guides": ["juniper-ex-series.pdf"], "best_practices": ["juniper-802.1x-config.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Juniper');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'Extreme Networks', 'network', 'switch', 'Cloud-driven networking solutions', 'https://extremenetworks.com', 'supported', '{"guides": ["extreme-exos-guide.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Extreme Networks');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'Arista', 'network', 'switch', 'Cloud networking solutions', 'https://arista.com', 'supported', '{"guides": ["arista-eos-guide.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Arista');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'HP Enterprise', 'network', 'switch', 'Enterprise networking infrastructure', 'https://hpe.com', 'supported', '{"guides": ["hpe-procurve-guide.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'HP Enterprise');

INSERT INTO public.vendor_library (vendor_name, category, vendor_type, description, website_url, portnox_integration_level, portnox_documentation)
SELECT 'Dell Technologies', 'network', 'switch', 'Enterprise networking and infrastructure', 'https://dell.com', 'supported', '{"guides": ["dell-os10-guide.pdf"]}'::jsonb
WHERE NOT EXISTS (SELECT 1 FROM public.vendor_library WHERE vendor_name = 'Dell Technologies');
