...
CREATE TABLE IF NOT EXISTS public.risk_assessments (
  ...
  owner_assigned_to UUID REFERENCES auth.users(id),
...
-- Create RLS policies for customer_portal_branding
...
-- Create RLS policies for project_meetings
...
CREATE INDEX idx_customer_portal_branding_project_id ON public.customer_portal_branding(project_id);
...
CREATE INDEX idx_risk_assessments_risk_score ON public.risk_assessments(risk_score);
