-- ========================================
-- Comprehensive Best Practices Library Population (Fixed)
...
-- Insert Use Cases (using correct column names)
INSERT INTO use_case_library (name, description, category, complexity, business_value, technical_requirements, prerequisites, portnox_features, compliance_frameworks, tags) VALUES
...
'{"PCI-DSS", "HIPAA", "SOC2"}',
'{"eap-tls", "certificates", "corporate", "authentication"}'),
...
'{"SOC2", "ISO27001"}',
'{"byod", "segmentation", "device-profiling", "self-service"}'),
...
'{"SOC2", "ISO27001", "NIST"}',
'{"iot", "micro-segmentation", "automated-profiling", "behavioral-analysis"}'),
...
'{"SOC2", "GDPR"}',
'{"guest-access", "captive-portal", "network-isolation", "terms-acceptance"}');

-- Insert Requirements (using correct column names)
