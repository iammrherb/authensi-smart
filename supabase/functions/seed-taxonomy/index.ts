  ...
  try {
    ...
    const vendorLibrary = [
      { 
        ...
        category: "NAC", 
        description: "Leading network infrastructure vendor with comprehensive NAC solutions",
        website_url: "https://cisco.com",
        status: "active", 
        portnox_integration_level: "certified", 
        supported_protocols: ["802.1X", "RADIUS", "TACACS+"], 
        integration_methods: ["API", "SNMP"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://cisco.com/docs" },
        tags: ["network", "nac", "certified"],
        is_nac_vendor: true
      },
      { 
        vendor_name: "Aruba", 
        vendor_type: "Network Infrastructure", 
        category: "NAC", 
        description: "Enterprise wireless and network access control solutions",
        website_url: "https://aruba.com",
        status: "active", 
        portnox_integration_level: "certified", 
        supported_protocols: ["802.1X", "RADIUS"], 
        integration_methods: ["API", "SNMP"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://aruba.com/docs" },
        tags: ["wireless", "nac", "certified"],
        is_nac_vendor: true
      },
      { 
        vendor_name: "Juniper", 
        vendor_type: "Network Infrastructure", 
        category: "NAC", 
        description: "Network infrastructure with enterprise-grade security features",
        website_url: "https://juniper.net",
        status: "active", 
        portnox_integration_level: "supported", 
        supported_protocols: ["802.1X", "RADIUS"], 
        integration_methods: ["SNMP"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://juniper.net/docs" },
      ...
      { 
        ...
        website_url: "https://fortinet.com",
        status: "active", 
        portnox_integration_level: "supported", 
        supported_protocols: ["RADIUS"], 
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://fortinet.com/docs" },
      ...
      { 
        ...
        website_url: "https://paloaltonetworks.com",
        status: "active", 
        portnox_integration_level: "certified", 
        supported_protocols: ["RADIUS"], 
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://paloaltonetworks.com/docs" },
        tags: ["security", "ngfw", "certified"],
        is_nac_vendor: false
      },
      { 
        ...
        status: "active", 
        portnox_integration_level: "certified", 
        supported_protocols: ["SAML", "OAuth"], 
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://microsoft.com/docs" },
        tags: ["identity", "saml", "certified"],
        is_nac_vendor: false
      },
      { 
        vendor_name: "Okta", 
        ...
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://okta.com/docs" },
        tags: ["identity", "cloud", "certified"],
        is_nac_vendor: false
      },
      { 
        vendor_name: "VMware", 
        vendor_type: "Virtualization", 
        category: "Infrastructure", 
        description: "Virtualization and cloud infrastructure solutions",
        website_url: "https://vmware.com",
        status: "active", 
        portnox_integration_level: "supported", 
        supported_protocols: ["SNMP"], 
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://vmware.com/docs" },
      ...
      { 
        ...
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://crowdstrike.com/docs" },
      ...
      { 
        ...
        integration_methods: ["API"], 
        known_limitations: [],
        portnox_documentation: { "integration_guide": "https://sentinelone.com/docs" },
        tags: ["endpoint", "ai", "security"],
        is_nac_vendor: false
      }
    ];
